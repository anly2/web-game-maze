...
if(isset($_REQUEST['js'])){
   ...
   if($_REQUEST['js']=='specials'){
      ...
      echo '         lastSpecial = 8;'."\n";
      echo "\n";
      echo '         var color   = "#8264b1";'."\n";
      echo '         break;'."\n";
      echo '      default:'."\n";
      echo '         var color   = "#ffffff";'."\n";
      echo '         lastSpecial = -1;'."\n";
      echo '   }'."\n";
      echo '   document.getElementById(ele).prevBackgroundColor   = color;'."\n";
      echo '   document.getElementById(ele).style.backgroundColor = color;'."\n";
      echo '}'."\n";
      echo "\n";
      echo "\n";
   ...
   if($_REQUEST['js']=='export'){
      ...
      echo '   var code  = "time=200&start="+convert(start)+"&end="+convert(end)+"&next=\n";'."\n";
      echo "\n";
...
echo '                        <tr>'."\n";
echo '                           <td>'."\n";
echo '                        		<table id="special:0" class="special" style="display:none;"'."\n";
...
echo '                        <tr>'."\n";
echo '                           <td>'."\n";
echo '                        		<table id="special:1" class="special" style="display:none;"'."\n";
